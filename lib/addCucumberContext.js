...
function log(msg, level) {
    ...
    logMethod(`[${chalk.gray('cucumber')}] ${out}\n`)
}
 ...
 *
 *   addCucumberContext(this, 'some context to add');
 *
 *   addCucumberContext(this, {
...
const addCucumberContext = function (...args) {
     ...
     * If `addCucumberContext` is called from inside a hook the test object
...
module.exports = addCucumberContext
