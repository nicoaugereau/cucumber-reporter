...
function generateReport(options) {
	...
	let graphPending = (Number(parseFloat(suite.featureCount.passedPercentage)) + Number(parseFloat(suite.featureCount.failedPercentage)) + Number(parseFloat(suite.featureCount.pendingPercentage)))
	let graphSkipped = (Number(parseFloat(suite.featureCount.passedPercentage)) + Number(parseFloat(suite.featureCount.failedPercentage)) + Number(parseFloat(suite.featureCount.pendingPercentage)) +Number(parseFloat(suite.featureCount.skippedPercentage)))
	suite.graph = `#26b526 0, #26b526 ${graphPassed}%,#fa0f36 0,#fa0f36 ${graphFailed}%,#666 0, #666 ${graphSkipped}%,#99ddff 0, #99ddff ${graphPending}%`
